 ...
 * 2018-07-16T21:35:26.758+08:00
 * Generated source version: 3.2.5
 *
 */
@WebServiceClient(name = "DomesticAirline",
                  wsdlLocation = "file:/E:/Java/eclipse-workspace/FlightClient/src/flight.wsdl",
...
public class DomesticAirline extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Java/eclipse-workspace/FlightClient/src/flight.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DomesticAirline.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/E:/Java/eclipse-workspace/FlightClient/src/flight.wsdl");
        }
        WSDL_LOCATION = url;
    }
